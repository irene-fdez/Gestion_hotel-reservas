...
namespace GestionReservas.GUI.Dlg
{
    ...
    public class DIgInsertaHabitaciones :Form
    {
        public DIgInsertaHabitaciones()
        {
            this.Build();
            this.CenterToScreen();
        }
        
        public DIgInsertaHabitaciones(RegistroHabitaciones Habitaciones, List<Habitacion> habitacionesList)
        {
          ...
          void Build()
        {
         ...
         /*   var pnlTipo = this.BuilTipo();
            ...
            this.Text = "Gestion de un hotel - Añadir Habitacion";

            Console.WriteLine(pnlHabitacion.Height);

            this.Size = new Size(600,
                      100 + pnlHabitacion.Height + pnlEspacio.Height + pnlnumHabitacion.Height  
       ...
       private void BuildStatus()
        ...
        Panel BuildHabitacion()
        {
            ...
            this.numeroHabitacion = new NumericUpDown()
            {
                Left = 0,
                Width = 250,
                Anchor = AnchorStyles.Bottom,
            ...
            pnlNumHabitacion.Controls.Add(numeroHabitacion);
